...
export default function CheckoutFail({ route }) {
    const { state, dispatch: ctxDispatch } = useContext(Store);
    const {
        cart
    } = state;

    console.log(cart.failType);
    ...
    return (
        <div>
            ...
            <div className="container d-flex flex-column align-items-center">
                ...
                {cart.failType == "ITEM_QUANTITY_ERROR" ? (<>
                    ...
                    <div className="container">
                        ...
                        <h4 className="mb-3 text-center cko-h4">Voucher đã hết lượt sử dụng</h4>
                    </>)}
